...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('ahha-js', get_template_directory_uri() . '/js/main-min.js', array('jquery'), '1.0.0', true); // Custom scripts
...
{
    wp_register_style('ahha-styles', get_template_directory_uri() . '/css/main.css', array(), '1.0', 'all');
